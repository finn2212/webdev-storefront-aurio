<template>
  <div class="address-manager" style="border: 0px;">
    <SfHeading
    ...
    >
      ...
      <div class="address-manager__list">
        ...
        <div class="sf-button-container">
          <SwButton
            class="sf-button color-secondary address-manager__add-new btn"
            @click="
              isModalOpen = true
          ...
          <SwButton
            class="sf-button color-secondary address-manager__edit btn"
            @click="
              isModalOpen = true
              isEditModeOpen = false
              isAddNew = false
